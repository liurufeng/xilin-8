<?php echo view($_SESSION['tm'].'uc/header.php') ?>
  ...
  <div class="row">
  <ul>
      <li><a href="/account/index.html">Parent(<b>ID <?= session()->get('userresult')[0]['parent_id'] ?></b>)</a></li>
      <li><a href="/account/students">Students|Register</a></li>
      <li><a href="/homework/index">Homework</a></li>
      <li><a href="/account/invoice" target="_blank">Invoice</a></li>
      <li><a href="/account/pay_instruction" class="active_menu">Payment</a></li>
    <?if($_SESSION['tm']!='ccc/'){?><li><a href="/pod/index">POD Sign-up</a></li> <?}?>
