...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#D6D6D6">
    ...
    <td height="27" colspan="10" background="<?php echo base_url();?>/admin/images/tbg.gif" bgcolor="#E7E7E7">
        ...
        <tr>
          <td width="30%" style="padding-left:5px;">
            <form action="<?=$_SESSION['admin_path']?>manualpod/index">
          ...
          <td width="15%" align="right"><b>
          	<a href="<?=$_SESSION['admin_path']?>manualpod/add"><u>add manual pod records</u></a>
          	</b>
          </td>
        </tr>
      </table>
  ...
  <tr bgcolor="#FBFCE2">
    ...
    <td width="10%" align="center">manual records</td>
  ...
  <tr align="center" bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';">
    ...
    <td><?php echo $v['manual_records']?></td>
    <td><?php echo $v['notes']?></td>
    <td>
		<a href='<?=$_SESSION['admin_path']?>manualpod/edit?manual_pod_record_id=<?php echo $v['manual_pod_record_id']?>'><u>edit</u></a> |
    <!--<a href='<?php /*echo site_url('manualpod/copy')*/?>?manual_pod_record_id=<?php /*echo $v['manual_pod_record_id']*/?>'><u>copy</u></a> |-->
		<a href='<?=$_SESSION['admin_path']?>manualpod/del?manual_pod_record_id=<?php echo $v['manual_pod_record_id']?>' onclick="return confirm('Are you sure to delete this record?')"><u>delete</u></a>
    </td>
  </tr>
  <?php } ?>
</table>
