  ...
  <tr>
    <td height="19" background="<?php echo base_url();?>/admin/images/tbg.gif" bgcolor="#E7E7E7"> 
      <table width="96%" border="0" cellspacing="1" cellpadding="1">
        <tr> 
          <td width="24%" style="padding-left:10px;"><b><strong>teacher add</strong></b> </td>
...
<tr>
	...
	<form name="form1" action="<?=$_SESSION['admin_path']?>teacher/add" onSubmit="return checkSubmit();" method="post">
	<input type="hidden" name="dopost" value="add" />
  		<table width="98%" border="0" cellspacing="1" cellpadding="1">
          <tr> 
            <td width="16%" height="30"><span style="color:red;">*</span>Email：</td>
            <td width="84%"  style="text-align:left;"><input name="email" type="text" id="email" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="30"><span style="color:red;">*</span>Password：</td>
            <td style="text-align:left;"><input name="passwd" type="password" id="passwd" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="30"><span style="color:red;">*</span>English Name：</td>
            <td style="text-align:left;"><input name="en_name" type="text" id="en_name" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td style="text-align:left;"><input name="cn_name" type="text" id="cn_name" size="16" style="width:200px" /></td>
          </tr>
        
          <tr> 
            <td height="30"><span style="color:red;">*</span>Home Phone：</td>
            <td style="text-align:left;"><input name="phone1" type="text" id="phone1" size="16" style="width:200px" /></td>
          </tr>
        
          <tr> 
            <td height="30">Cell Phone：</td>
            <td style="text-align:left;"><input name="phone2" type="text" id="phone2" size="16" style="width:200px" /></td>
          </tr>
        
          <tr> 
            <td height="30">Home Address：</td>
            <td style="text-align:left;"><input name="address" type="text" id="address" size="16" style="width:200px" /></td>
          </tr>
         
          <tr> 
            <td height="30">Bio URL：</td>
            <td style="text-align:left;"><input name="desc_link" type="text" id="desc_link" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="60">&nbsp;</td>
