  ...
  <tr>
    <td height="19" background="<?php echo base_url();?>/admin/images/tbg.gif" bgcolor="#E7E7E7"> 
      <table width="96%" border="0" cellspacing="1" cellpadding="1">
        <tr> 
          <td width="24%" style="padding-left:10px;"><b><strong>semester add</strong></b> </td>
...
<tr>
	...
	<form name="form1" action="<?=$_SESSION['admin_path']?>semester/add" onSubmit="return checkSubmit();" method="post">
	<input type="hidden" name="dopost" value="add" />
  		<table width="98%" border="0" cellspacing="1" cellpadding="1">
          <tr> 
            <td width="16%" height="30"><span style="color:red;">*</span>semester year：(e.g. 2016)</td>
            <td width="84%"  style="text-align:left;"><input name="semester_year" type="text" id="semester_year" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td style="text-align:left;"><input name="late_registration" type="text" id="late_registration" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="30">registration fee：</td>
            <td style="text-align:left;"><input name="registration_fee" type="text" id="registration_fee" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="30">late registration fee：</td>
            <td style="text-align:left;"><input name="late_registration_fee" type="text" id="late_registration_fee" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="30">parent discount base：</td>
            <td style="text-align:left;"><input name="parent_discount_base" type="text" id="parent_discount_base" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="30">teacher discount base：</td>
            <td style="text-align:left;"><input name="teacher_discount_base" type="text" id="teacher_discount_base" size="16" style="width:200px" /></td>
          </tr>
          <tr> 
            <td height="30">show flag：</td>
            <td style="text-align:left;">
            	<input type="radio" value="1" name="show_flag" checked/>是
            	<input type="radio" value="0" name="show_flag" />否
            </td>
          </tr>
        <tr>
          <td height="30">show calendar：</td>
          <td style="text-align:left;">
            <input type="radio" value="1" name="show_calendar" checked/>是
            <input type="radio" value="0" name="show_calendar" />否
          </td>
        </tr>
          <tr> 
            <td height="60">&nbsp;</td>
