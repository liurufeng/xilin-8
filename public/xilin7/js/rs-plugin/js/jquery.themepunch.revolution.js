...
********************************/
		...
		*******************************************************/
		...
		var setSize = function(img,opt) {
			...
			//if don't want resize, return
			//return ;

				opt.container.closest('.forcefullwidth_wrapper_tp_banner').find('.tp-fullwidth-forcer').css({'height':'500px'});
				opt.container.closest('.rev_slider_wrapper').css({'height':'500px'});
			...
			//opt.container.closest('.rev_slider_wrapper').css({'height':opt.container.height()});
				...
				opt.bh = 1; //(opt.height / opt.startheight);
			...
			//opt.height= opt.startheight * opt.bh;
				opt.height = 500; //Math.round(opt.startheight * (opt.width/opt.startwidth));
			...
			opt.height = 500;
				if (opt.fullScreen=="on") {
						...
						var coh = opt.height = 500; //jQuery(window).height();
						...
						opt.container.css({'height':'500px'});

						opt.height=500 //coh;
						if (opt.minHeight!=undefined && opt.height<opt.minHeight)
							opt.height = 500;// opt.minHeight;
				} else {
						if (opt.minHeight!=undefined && opt.height<opt.minHeight)
							opt.height = 500;//opt.minHeight;

						opt.container.height(500);
				}
