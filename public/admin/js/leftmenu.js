...
function ShowMainMenu(n)
{
  ...
  return false;
	var curLink = document.getElementById('link'+curitem);
	var targetLink = document.getElementById('link'+n);
	var curCt = document.getElementById('ct'+curitem);
	var targetCt = document.getElementById('ct'+n);
